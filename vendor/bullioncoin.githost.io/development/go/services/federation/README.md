...
[Prebuilt binaries](https://bullioncoin.githost.io/development/go/releases) of the federation server are available on the [releases page](https://bullioncoin.githost.io/development/go/releases).
...
```
go get -u bullioncoin.githost.io/development/go/services/federation
```
